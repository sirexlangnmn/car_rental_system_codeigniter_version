$(function(){
    ...
    var base_url='http://localhost/admin_display/calendar'; // Here i define the base_url
    ...
    $('.modal').on('click', '#update-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post(base_url+'calendar/updateEvent', {
                reservation_ID: currentEvent._id,
                title: $('#title').val(),
                description: $('#description').val(),
                color: $('#color').val()
            }, function(result){
    ...
    $('.modal').on('click', '#delete-event',  function(e){
        $.get(base_url+'calendar/deleteEvent?reservation_ID=' + currentEvent._id, function(result){
