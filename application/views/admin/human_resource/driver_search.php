          ...
          <div class="box">
            ...
            <!-- /.box-header -->
             ...
             <thead style="background-color: #00b0ff">
                ...
                <tbody>
                  <?php foreach ($driver_search as $row) { ?>  
                 <tr> 
                    <td><?php echo form_checkbox();?></td>                                       
                    <td><?php echo $row->driver_ID; ?></td>
                    <!--t><?php // echo '<img src="data:image/jpeg;base64,'.base64_encode( $row->driver_pic ).'"/>'; ?></th-->
                    <td><img src="<?php echo base_url(); ?>drivers/<?php echo $row->driver_Image?>" height="70" width="100"></td>
                    ...
                    <td>
                      <a rel="tooltip" data-placement="bottom" title="Update Driver Details" 
                        id="Update Driver Details" href="<?php echo base_url(); ?>admin_get/driver_get/<?php echo $row->driver_ID ?>"><i class="fa fa-pencil"></i>
                      </a>
                    </td>        
                    <td>
                      <a rel="tooltip" data-placement="bottom" title="View Driver Details" 
                        id="View Driver Details" href="<?php echo base_url(); ?>admin_get/driver_show/<?php echo $row->driver_ID ?>"><i class="fa fa-eye"></i>
                      </a>
                    </td>
                    <td>
                      <a rel="tooltip" data-placement="bottom" title="Delete Driver Details" 
                        id="View Driver Details" href="<?php echo base_url(); ?>admin_delete/driver_delete/<?php echo $row->driver_ID ?>"><i class="fa fa-trash"></i>
                      </a>
                    </td>
                ...
                <tr>
                 ...
                 <div align="right">
                              ...
                              <a rel="tooltip" data-placement="bottom" title="Add Driver" 
                              id="Add Driver" href="#" class="btn btn-app" data-toggle="modal" 
                              data-target="#add_driver"><i class="fa fa-plus-square"></i>Add</a>

                              <a rel="tooltip" data-placement="bottom" title="Multiple Delete" 
                              id="Delete Driver" href="" class="btn btn-app">
