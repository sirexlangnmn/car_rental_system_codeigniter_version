                ...
                <tbody>
                  ...
                  <tr>
                     ...
                     <td><span class="label label-<?php echo $flag; ?>" align="center"></i><?php echo $row->reservation_status; ?></span></td> 
                      ...
                      <td>
                        <a rel="tooltip" data-placement="bottom" title="Send Message" 
                          id="Send Message" href="<?php echo base_url(); ?>admin_get/reservation_message/<?php echo $row->reservation_ID ?>"><i class="fa fa-envelope"></i>
                        </a>
                      </td>
                      <td>
                        <a rel="tooltip" data-placement="bottom" title="Payment" 
                          id="Payment" href=""><i class="fa fa-money"></i>
                        </a>
                      </td>
                      </td>
                      <td>
                        <a rel="tooltip" data-placement="bottom" title="Delete Car Details" 
                          id="Delete Car Details" href=""><i class="fa fa-user"></i>
                        </a>
                      </td>
                   </tr>
