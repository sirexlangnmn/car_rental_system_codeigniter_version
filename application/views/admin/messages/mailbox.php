          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="<?php echo base_url(); ?>admin_display/mailbox"><i class="fa fa-inbox"></i> Inbox
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="<?php echo base_url(); ?>admin_display/read_mail">Juan Dela Cruz</a></td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="<?php echo base_url(); ?>admin/read_mail">Juan Dela Cruz</a></td>
                    <td class="mailbox-subject"><b>Subject Here</b> - Trying to find a solution to this problem...
                    </td>
                  ...
                  <tr>
                    <td><div class="checkbox no-margin"><label><input type="checkbox"></label></div></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"><a href="<?php echo base_url(); ?>admin/rea_mail">Juan Dela Cruz</a></td>
                    <td class="mailbox-subject"><b>Subject Here</b> - Trying to find a solution to this problem...
                    </td>
                    <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
