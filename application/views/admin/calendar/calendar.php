...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'admin_assets/calendar_asset/css/bootstrap.min.css'; ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'admin_assets/calendar_asset/css/style.css'; ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'admin_assets/calendar_asset/font-awesome/css/font-awesome.min.css'; ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'admin_assets/calendar_asset/plugins/fullcalendar/fullcalendar.css'; ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'admin_assets/calendar_asset/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css'; ?>">
</head>    
...
<div class="content-wrapper">   <!-- Content Wrapper. Contains page content -->
  <section class="content-header">    <!-- Content Header (Page header) -->
    <h1>Calendar<small>Reservation List</small></h1>
  </section>
                  ...
                  <div class="portlet-body">
                    <div class="table-toolbar">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="btn-group">
                            <a href="#" class="btn btn-default">ADD NEW EVENT<i class="fa fa-plus"></i></a>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="modal-content">
                          <form class="form-horizontal" method="POST" action="POST" id="form_create">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                  <label class="control-label col-sm-2">Dropoff Location </label>
                                  <div class="col-sm-10">
                                    <input type="text" name="title" class="form-control" placeholder="Dropoff Location">
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                    <input type="text" name="description" class="form-control" placeholder="Pickup location">
                                  </div>
                                </div>
...
<script type="text/javascript" src="<?php echo base_url().'admin_assets/calendar_asset/js/jquery.min.js'; ?>"></script>      
<script type="text/javascript" src="<?php echo base_url().'admin_assets/calendar_asset/js/moment.min.js'; ?>"></script>      
<script type="text/javascript" src="<?php echo base_url().'admin_assets/calendar_asset/js/bootstrap.min.js'; ?>"></script>      
<script type="text/javascript" src="<?php echo base_url().'admin_assets/calendar_asset/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js'; ?>"></script>      
<script type="text/javascript" src="<?php echo base_url().'admin_assets/calendar_asset/plugins/fullcalendar/fullcalendar.js'; ?>"></script>      
    ...
    var backend_url     = '<?php echo base_url(); ?>';
        ...
        function editDropResize(event)
        {
            ...
            $.ajax({
                url     : backend_url+'calendar/save',
                type    : 'POST',
                data    : 'calendar_id='+event.reservation_ID+'&title='+event.title+'&start_date='+start+'&end_date='+end,
                dataType: 'JSON',
                beforeSend: function()
                {
                },
        ...
        {
            $('#create_modal input[name=calendar_id]').val(event.reservation_ID);
        ...
        function deleteData(event)
        {
            $('#create_modal .delete_calendar').click(function(){
                $.ajax({
                    ...
                    type    : 'POST',
                    data    : 'reservation_ID='+event.reservation_ID,
                    dataType: 'JSON',
                    beforeSend: function()
                    {
                    },
                    success: function(data)
                    {
                        if(data.status)
                        {   
                            $('#calendarIO').fullCalendar('removeEvents',event._reservation_ID);
                            $('#create_modal').modal('hide');
                            $('#form_create')[0].reset();
                            $('#create_modal input[name=calendar_id]').val(0)
                            $('.notification').removeClass('alert-danger').addClass('alert-primary').find('p').html(data.notif);
