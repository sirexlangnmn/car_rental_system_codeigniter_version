...
<div class="modal fade" id="addbrand" tabindex="-2" role="dialog" aria-labelledby="myModalLabel">
...
<div style="margin-top: -15px">
  ...
  <div class="login-box-body">
    ...
    <h3 class="login-box-msg"><i class="fa fa-pencil"></i>Add Car Brand</h3>

 <?php echo form_open('admin_insert/brand_insert'); ?>
       <div class="form-group has-feedback">
        <input type="text" class="form-control" name="brand_Name" placeholder="Car Brand">
