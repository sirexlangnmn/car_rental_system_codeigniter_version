...
<div class="modal fade" id="addrating" tabindex="-2" role="dialog" aria-labelledby="myModalLabel">
...
<div style="margin-top: -15px">
  ...
  <div class="login-box-body">
    ...
    <h3 class="login-box-msg"><i class="fa fa-pencil"></i>Add Car Rating</h3>
 
 <?php echo form_open('Admin_insert/rating_insert'); ?>
       <div class="form-group has-feedback">
        <input type="text" class="form-control" name="rating" placeholder="Rating">
        <span class="fa fa-car form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="rating_date" placeholder="Rating Date">
        <span class="fa fa-car form-control-feedback"></span>
      </div>
