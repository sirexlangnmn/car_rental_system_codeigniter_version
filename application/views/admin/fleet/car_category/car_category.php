          ...
          <div class="box">
            ...
            <h4><b>Car Category</b></h4>
              ...
              <table id="example1" class="table table-bordered table-striped">
                       ...
                       <?php foreach ($category as $row) { ?>   
                          <tr>
                             ...
                             <td>
                                ...
                                href="<?php echo base_url(); ?>Admin_get/cat_get/<?php echo $row->category_ID ?>">
                                <i class="fa fa-pencil"></i>
                                </a>
                             </td>   
                             <td>
                                <a rel="tooltip" data-placement="bottom" title="Delete Category" id="Delete Category" 
                                href="<?php echo base_url(); ?>Admin_delete/cat_delete/<?php echo $row->category_ID?>">
                  ...
                  <div align="right">
                    <a rel="tooltip" data-placement="bottom" title="Add Category" id="Add Category" href="#" class="btn btn-app" data-target="#addcategory" data-toggle="modal"><i class="fa fa-plus-square"></i>Add</a> 
                  </div>
              </table>
              <?php echo $links ?>
          </div>
